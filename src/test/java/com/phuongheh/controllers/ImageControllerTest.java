...
import com.phuongheh.services.ImageService;
...
public class ImageControllerTest {
    ...
    public void handleImagePost() throws Exception {
        MockMultipartFile multipartFile = new MockMultipartFile("imagefile", "testing.txt", "txt/plain", "Spring Framework Guru".getBytes());
